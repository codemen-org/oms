...
class AppColors {
  ...
  static const Color primeryColor = Color(0xFF5D5FEF);
  static const Color secondaryColor = Color(0xFF66B8DE);
  static const Color appColorFFFFFF = Color(0xFFFFFFFF);
  static const Color successColor = Color(0xFF61BE8C);
  static const Color infoColor = Color(0xFF66B8DE);
  ...
  static const Color text60 = Color(0xFF797979);
  static const Color text40 = Color(0xFFA5A3A3);
  static const Color text30 = Color(0xFFCECECE);
  static const Color text20 = Color(0xFFD8D7D7);
  static const Color text10 = Color(0xFFF3F4FB);
  static const Color text5 = Color(0xFFF2F2F2);
  static Color tableBg5 = Color.fromRGBO(243, 244, 251, 0.5);
