...
import '../features/authentication/data/rx_post_get_emp/rx.dart';
import '../features/authentication/data/signup/rx.dart';

import '../features/dashboard/data/rx_post_leave_db_data/rx.dart';
import '../features/leaverequest/data/rx_get_leave_detail/rx.dart';
...
GetEmpApilRX getEmpApilRXObj = GetEmpApilRX();
GetLeaveDetailReqRX getLeaveDetailReqRXObj = GetLeaveDetailReqRX();
PostDeviceTokenRX postDeviceTokenRXObj = PostDeviceTokenRX();
GetLeaveDBRX getLeaveDBRXObj = GetLeaveDBRX();
