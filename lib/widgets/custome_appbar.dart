...
class appbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: getProfileReqRXObj.getProfileResStream,
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            Map data = snapshot.data["user"];
            return Column(
              children: [
                Container(
                  height: .32.sh,
                  child: Stack(
                    children: [
                      ...
                      ListTile(
                        ...
                        leading:
                            Icon(Icons.menu, size: 24, color: AppColors.white),
                        title: Padding(
                ...
                Text(
                  data["first_name"] +
                      ...
                      " " +
                      data["username"],
                  style: TextFontStyle.headline1StyleInter
